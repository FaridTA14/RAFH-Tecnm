		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
			<div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 hover:shadow-lg transition-shadow">
				<div class="flex items-center justify-between mb-4">
					<h3 class="text-lg font-bold text-gray-900 dark:text-white">Administrador</h3>
					<div class="flex gap-2">
						<button @click="showEditRolModal = true" class="p-2 bg-blue-600 hover:bg-blue-700 text-white rounded transition-colors">
				...
				<p class="text-gray-600 dark:text-gray-400 text-sm">Acceso total al sistema</p>
			...
			<div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 hover:shadow-lg transition-shadow">
				<div class="flex items-center justify-between mb-4">
					<h3 class="text-lg font-bold text-gray-900 dark:text-white">Gestor</h3>
					<div class="flex gap-2">
						<button @click="showEditRolModal = true" class="p-2 bg-blue-600 hover:bg-blue-700 text-white rounded transition-colors">
							<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
				...
				<p class="text-gray-600 dark:text-gray-400 text-sm">Acceso a gestión de bienes</p>
				<div class="mt-4 space-y-2 text-sm">
					<p class="text-gray-600 dark:text-gray-400">Permisos:</p>
					<ul class="list-disc list-inside text-gray-600 dark:text-gray-400">
						<li>Ver reportes</li>
